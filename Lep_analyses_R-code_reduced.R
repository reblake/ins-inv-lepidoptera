...
make_scatterplots <- function(df, title, xlab){
...
a1 <- make_scatterplots(alien1, "b)", NULL) 
a2 <- make_scatterplots(alien2, "d)", NULL)
a3 <- make_scatterplots(alien3, "f)", expression(paste("Area (km" ^ "2", ")")))
n1 <- make_scatterplots(native1, "a)", NULL)
